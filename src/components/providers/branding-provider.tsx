...
export function BrandingProvider({
  ...
  useEffect(() => {
    ...
    if (storedBranding) {
      ...
      const mergedBranding = brandingUtils.mergeBranding(
        defaultBranding,
        initialBranding,
      );
  ...
  const contextValue: BrandingContextType = {
    ...
    departmentBranding: departmentBranding
      ? { departmentId: "", departmentName: "", branding: departmentBranding }
      : undefined,
    updateBranding,
    resetBranding,
  };
...
export function useBrandingValue<K extends keyof BrandingConfig>(
  key: K,
): BrandingConfig[K] {
