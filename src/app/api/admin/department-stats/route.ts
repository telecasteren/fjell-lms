  ...
  try {
    ...
    return NextResponse.json({
      department: {
        ...
        darkModeLogoUrl: department.darkModeLogoUrl,
        logoText: department.logoText,
        parentDepartmentId: department.parentDepartmentId,
        parentDepartment: department.parentDepartment,
        footerLinkSectionTitle: department.footerLinkSectionTitle,
        footerLink1Url: department.footerLink1Url,
        footerLink1Text: department.footerLink1Text,
        footerLink2Url: department.footerLink2Url,
        footerLink2Text: department.footerLink2Text,
        footerLink3Url: department.footerLink3Url,
        footerLink3Text: department.footerLink3Text,
        footerContactEmail: department.footerContactEmail,
        footerContactPhone: department.footerContactPhone,
        footerContactAddress: department.footerContactAddress,
        footerContactAddress2: department.footerContactAddress2,
      },
      stats: {
        completionRate,
        totalLessons,
